...
BSW/IO/ToF.o \
BSW/IO/Ultrasonic.o \
BSW/IO/motorDriver.o 


# Each subdirectory must supply rules for building sources it contributes
BSW/IO/Bluetooth.src: ../BSW/IO/Bluetooth.c BSW/IO/subdir.mk
	cctc -cs --dep-file="$(*F).d" --misrac-version=2004 -D__CPU__=tc37x "-fC:/First_project/my_prj2/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc37x -Y0 -N0 -Z0 -o "$@" "$<"
...
BSW/IO/Ultrasonic.o: BSW/IO/Ultrasonic.src BSW/IO/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
BSW/IO/motorDriver.src: ../BSW/IO/motorDriver.c BSW/IO/subdir.mk
	cctc -cs --dep-file="$(*F).d" --misrac-version=2004 -D__CPU__=tc37x "-fC:/First_project/my_prj2/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc37x -Y0 -N0 -Z0 -o "$@" "$<"
BSW/IO/motorDriver.o: BSW/IO/motorDriver.src BSW/IO/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"

clean: clean-BSW-2f-IO

clean-BSW-2f-IO:
	-$(RM) BSW/IO/Bluetooth.d BSW/IO/Bluetooth.o BSW/IO/Bluetooth.src BSW/IO/Buzzer.d BSW/IO/Buzzer.o BSW/IO/Buzzer.src BSW/IO/GPIO.d BSW/IO/GPIO.o BSW/IO/GPIO.src BSW/IO/Motor.d BSW/IO/Motor.o BSW/IO/Motor.src BSW/IO/ToF.d BSW/IO/ToF.o BSW/IO/ToF.src BSW/IO/Ultrasonic.d BSW/IO/Ultrasonic.o BSW/IO/Ultrasonic.src BSW/IO/motorDriver.d BSW/IO/motorDriver.o BSW/IO/motorDriver.src
