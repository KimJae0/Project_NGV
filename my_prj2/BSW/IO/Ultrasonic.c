...
//        ; // Trigger Pulse during 20us
//    MODULE_P15.OUT.B.P3 = 0; // TRIG_LOW
//
//    /* Calculate Distance */
//    uint64 timeout = getTimeUs();
//    while (MODULE_P15.IN.B.P2 == 0)
//    { // wait for ECHO_HIGH
//        if (getTimeUs() - timeout > 20000)
//            return -1.0f; // if echo pin does not triggered until 20ms, return error value
//    }
//    timer_start = getTimeUs();
//    while (MODULE_P15.IN.B.P2 == 1)
//        ; // wait for ECHO_LOW
//    timer_end = getTimeUs();
//
//    right_duration = (timer_end - timer_start);
//    if (right_duration > 5850)
//        return 100.0f; // out of range
...
//    /* Calculate Distance */
//    uint64 timeout = getTimeUs();
//    while (MODULE_P02.IN.B.P8 == 0)
//    { // wait for ECHO_HIGH
//        if (getTimeUs() - timeout > 20000)
//            return -1.0f; // if echo pin does not triggered until 20ms, return error value
//    }
//    timer_start = getTimeUs();
//    while (MODULE_P02.IN.B.P8 == 1)
//        ; // wait for ECHO_LOW
//    timer_end = getTimeUs();
//
//    left_duration = (timer_end - timer_start);
//    if (left_duration > 5850)
//        return 100.0f; // out of range
